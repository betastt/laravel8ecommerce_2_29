				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+123) 456 789" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+57) 314 6671796</a>
								</li>
							</ul>
						</div>
							...
							<ul>
								...
								@if(Route::has('login'))
									...
									@auth
										@if(Auth::user()->utype === 'ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a title="All Coffee Customizations" href="{{route('admin.personalizacioncafe')}}">All Coffee Customizations</a>
													</li>

													<li class="menu-item">
														<a title="All Product Presentation" href="{{route('admin.presentacionproducto')}}">All Product Presentation</a>
													</li>

													<li class="menu-item">
														<a title="All Taxes" href="{{route('admin.impuesto')}}">All Taxes</a>
													</li>

													<li class="menu-item">
														<a title="Manage Users" href="{{route('admin.usuariogestion')}}">Manage Users</a>
													</li>
										...
										@elseif (Auth::user()->utype === 'USR' && Auth::user()->status == 1)
											<li class="menu-item menu-item-has-children parent" >
												<a title="My Account" href="#">My Account ({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
												<ul class="submenu curency" >
													<li class="menu-item" >
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="{{ asset('assets/images/logo-top-1.png ') }}" width="100" height="100" alt="mercado"></a>
						</div>
						...
						<div class="wrap-icon right-section">
							...
							<div class="wrap-icon-section minicart">
								<a href="{{route('product.cart')}}" class="link-direction">
									<i style="margin-left:180px;" class="fa fa-shopping-basket" aria-hidden="true"></i>
									<div class="left-info">
										@if(Cart::count() > 0)
										<span class="index">{{Cart::count()}} items</span>
										@endif
										<span style="margin-left:180px;" class="title">CART</span>
									</div>
								</a>
							</div>
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">Monteria - 35-14 la Floresta</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">(+57) 314 6671796 - (+57) 300 6711304</p>
											</li>
											<li>
												<i class="fa fa-envelope" aria-hidden="true"></i>
												<p class="contact-txt">mcorchoperez@gmail.com</p>
											</li>											
										</ul>
									</div>
								</div>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+57) 314 6671796 - (+57) 300 6711304</b>
									</div>
								</div>
							</div>
...
<!-- 
	...
	<script src="https://cdn.tiny.cloud/1/ag5797j56mybbssdcnc667kyiszkfprz3dldkl63rzvsm0kl/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
